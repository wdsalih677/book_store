...
<script>
    $(document).ready(function() {
      // Add item when "Add Another" button is clicked
      $("#addItem").click(function() {
        var newItem = $("#repeaterContainer .repeater-item:first").clone();
      ...
      $("#repeaterContainer").on("click", ".removeItem", function() {
      ...
      $("#repeaterForm").submit(function(event) {
        ...
        // Access form data as an array
        var formData = $("#repeaterForm").serializeArray();
